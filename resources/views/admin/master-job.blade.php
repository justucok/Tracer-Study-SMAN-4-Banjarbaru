    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="row">
                ...
                {{-- search bar --}}
                <div class="col-6">
                    <form class="d-flex" action="{{ route('job.index') }}" method="GET" role="search">
        ...
        <div class="container-fluid text-end my-2 pe-4">
            <div class="row">
                ...
                <div class="col">
                    <a class="btn btn-primary btn-sm" target="blank" href="{{ route('job.show') }}">Download</a>
                </div>
            </div>
        </div>
        {{-- end download button --}}
            ...
            <div class="row align-items-start ">
                <div class="col">
                    ...
                    <div class="container my-2 mt-3">
                        <form class="col-6 d-flex" action="{{ route('job.index') }}" method="GET">
